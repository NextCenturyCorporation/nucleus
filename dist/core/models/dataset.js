...
var TableConfig = /** @class */ (function () {
    ...
    TableConfig.get = function (table) {
        ...
        return __assign(__assign({ name: '', prettyName: '', mappings: {}, labelOptions: {} }, table), { fields: translate(table.fields || [], FieldConfig.get.bind(null)) });
    };
    return TableConfig;
}());
...
var DatabaseConfig = /** @class */ (function () {
    ...
    DatabaseConfig.get = function (db) {
        if (db === void 0) { db = {}; }
        return __assign(__assign({ name: '', prettyName: '' }, db), { tables: translateValues(db.tables || {}, TableConfig.get.bind(null), true) });
    };
...
var DatastoreConfig = /** @class */ (function () {
    ...
    DatastoreConfig.get = function (config) {
        ...
        return __assign(__assign({ name: '', host: '', type: '' }, config), { databases: translateValues(config.databases || {}, DatabaseConfig.get.bind(null), true) });
    };
